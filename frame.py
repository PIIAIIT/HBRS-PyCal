...
def run():
    ...
    # Create a label
    CTkLabel(mainFrame, text="H-BRS Kalendergenerator", justify="center", font=(_font, 22)).pack(pady=15/2)
    ...
    CTkOptionMenu(mainFrame, variable=stringvar, values=arr, command=_print).pack(pady=15/2, anchor="center")
    ...
    CTkButton(root, text="Erstelle Ical", command=lambda : a.ical([d for checkbox, d in allCheckboxes if checkbox.get() == 1])).pack(pady=15/2, side="bottom", anchor="center")
